...
in1 = pd.read_csv("/truthSamples/arpit_truth.csv")
in2 = pd.read_csv("/lieSamples/arpit_lie.csv")
in3 = pd.read_csv("/truthSamples/nobha_truth.csv")
in4 = pd.read_csv("/lieSamples/nobha_lie.csv")
in5 = pd.read_csv("/truthSamples/nisha_truth.csv")
in6 = pd.read_csv("/lieSamples/nisha_lie.csv")
in7 = pd.read_csv("/truthSamples/priya_truth.csv")
in8 = pd.read_csv("/lieSamples/priya_lie.csv")
in9 = pd.read_csv("/truthSamples/shubhi_truth.csv")
in10 = pd.read_csv("/lieSamples/shubhi_lie.csv")
in11= pd.read_csv("/truthSamples/rakhi_truth.csv")
in12 = pd.read_csv("/lieSamples/rakhi_lie.csv")
in13= pd.read_csv("/truthSamples/nirma_truth.csv")
in14 = pd.read_csv("/lieSamples/nirma_lie.csv")
in15 = pd.read_csv("/truthSamples/komal_truth.csv")
in16 = pd.read_csv("/lieSamples/komal_lie.csv")
in17 = pd.read_csv("/truthSamples/kaajal_truth.csv")
in18 = pd.read_csv("/lieSamples/kaajal_lie.csv")
in19 = pd.read_csv("/truthSamples/disha_truth.csv")
in20 = pd.read_csv("/lieSamples/disha_lie.csv")
in21= pd.read_csv("/truthSamples/kushagra_truth.csv")
in22 = pd.read_csv("/lieSamples/kushagra_lie.csv")
in23= pd.read_csv("/truthSamples/himani_truth.csv")
in24 = pd.read_csv("/lieSamples/himani_lie.csv")
in25 = pd.read_csv("/truthSamples/malvika_truth.csv")
in26= pd.read_csv("/lieSamples/malvika_lie.csv")
in27= pd.read_csv("/truthSamples/risana_truth.csv")
in28= pd.read_csv("/lieSamples/risana_lie.csv")
in29= pd.read_csv("/truthSamples/jayti_truth.csv")
in30= pd.read_csv("/lieSamples/jayti_lie.csv")
